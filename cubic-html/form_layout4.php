...
if (isset($_POST['submit'])) {
   ...
   $name = $_POST['name'];
    ...
    $price = $_POST['price'];
    $valadity = $_POST['valadity'];
    $description = $_POST['description'];

    $sql = "UPDATE service SET name='$name',service_type='$service_type',price='$price', valadity='$valadity',description='$description' WHERE id=$id";
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form method="post" action="form_layout4.php">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Full Service Name:</label>
                                                        <input type="text" id="name" name="name" value="<?php echo $row['name']; ?>" class="form-control" placeholder="name">  </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group ">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" id="price" name="price"value="<?php echo $row['price']; ?>" class="form-control" placeholder="Service Price">  </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group ">
                                                        <label class="control-label">Service Valadity:</label>
                                                        <input type="text" id="valadity"name="valadity" value="<?php echo $row['valadity'];?>" class="form-control" placeholder="Valadity">  </div>
                                                </div>
                                                </div>
                                                </div>
                                                 <div class="row">
                                           <div class="col-md-6">
                                                     <div class="form-group ">
                                                        <label class="control-label"> Description:</label>
                                                         ...
                                                         <textarea name="description" value="" rows="3" ><?php echo $row['description']; ?></textarea>
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-success" name="submit"> <i class="fa fa-check"></i> Update Service</button>
