            ...
            <ul id="side-menu">
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a href="interview.php">Schedule Interview </a> </li>
                    </ul>
                </li>
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0"> Candidate Enquiry</h3>
                            <p class="text-muted m-b-30">  </p>
                         <!-- <p align="right">  <a class="btn btn-primary" href="addcand.php" role="button">Add Candidate</a></p> -->
...
$sql = "SELECT * FROM candidate_enquiry ORDER BY id DESC";
        ...
        ?>
                                    <tbody>
                                        <tr>
                                              ...
                                              <td>  
                                               <a href="candidate_enquiry.php?id=<?php echo $row['id']; ?>">View</a>
