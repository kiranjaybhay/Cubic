...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM candidate_enquiry WHERE id='$id'";
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <ul class="nav nav-tabs tabs customtab">
                                ...
                                <li class="active tab">
                                    <a href="#profile" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">View Candidate Enquiry</span> </a>
                                </li>
                                <!-- <li class="tab">
