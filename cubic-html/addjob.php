...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO job (title,location,position,description,experience,salary,worktype) VALUES ('$title', '$location', '$location','$description','$experience','$salary','$status')";
                                ...
                                <div class="panel-body">
                                    <form method="post" action="addjob.php">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="title" name="title" class="form-control" placeholder="title"required>  </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label">Position:</label>
                                                        <input type="text" id="position" name="position" class="form-control" placeholder="position"required>  </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label">Location:</label>
                                                        <input type="text" id="location"name="location" class="form-control" placeholder="location"required>  </div>
                                                </div>
                                                <!--/span-->
                                            </div>
                                            <!--/row-->
                                            ...
                                            <div class="row">
                                                 <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="experience" name="experience"required> </div>
                                                </div>
                                                <!--/span-->
                                            <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label">Salary: </label>
                                                        <input type="text" name="salary" class="form-control" placeholder="salary"required>  </div>

                                                        <!-- <input type="text" id="description"name="description" accept=".pdf" class="form-control" placeholder="Email">  </div> -->
                                                </div>
                                            <!--/row-->
                                                 <div class="col-md-4">
                                                    <div class="form-group ">
                                                 ...
                                                 <!-- <div class="col-md-6">
                                                     <div class="form-group ">
                                                        ...
                                                        <input type="text" name="mobile" class="form-control" placeholder=""required>  </div>
                                                </div> -->
                                                </div>
                                                 <div class="row">
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-success" name="submit"> <i class="fa fa-check"></i> Add job</button>
