...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO company (name,industry,email,address,website,discription,contact) VALUES ('$name', '$industry','$email','$address','$website','$description','$contact')";
...
//     // You can process and store the candidate's profile data as needed (e.g., save to a database)
                                ...
                                <div class="panel-body">
                                    <form method="post" action="addcompany.php">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name" name="name" class="form-control" placeholder="Enter Company name"required>  </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label">Industry Type:</label>
                                                        <input type="text" id="industry" name="industry" class="form-control" placeholder="industry"required>  </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                            ...
                                            <!--/row-->
                                                <div class="col-md-4">
                                                     <div class="form-group ">
                                                        ...
                                                        <input type="text" name="website" class="form-control" placeholder="website"required>  </div>
                                                </div>
                                                <div class="col-md-4">
                                                     <div class="form-group ">
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-success" name="submit"> <i class="fa fa-check"></i> Add Company</button>
