        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">  Interview Schedule</h3>
                            <p class="text-muted m-b-30">  </p>
                         <p align="right">  <a class="btn btn-primary" href="show.php" role="button">view Interviews</a></p>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ?>
                                    <tbody>
                                        <tr>
                                                <td><?php echo $row['cadidate_id']; ?></td>
                                                ...
                                                <!-- <td><?php //echo $row['status']; ?></td> -->
                                              <td>  
                                               <button type="button" class="btn btn-info" style= "margin: 2px";><a href="interviewsc.php?cadidate_id=<?php echo $row['cadidate_id']; ?>">Interview Schedule</a></button>
