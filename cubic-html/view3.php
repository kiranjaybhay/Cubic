                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <ul class="nav nav-tabs tabs customtab">
                                ...
                                <li class="active tab">
                                    <a href="#profile" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">View Company Details</span> </a>
                                </li>
                                <!-- <li class="tab">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="profile">
                                    <div class="row">
                                        <div class="col-md-1 col-xs-6 b-r"> <strong>sr.no. </strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['id']; ?></p>
                                        </div>
                                        <div class="col-md-2 col-xs-6 b-r"> <strong> Name</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['name']; ?></p>
                                        </div>
                                        <div class="col-md-2 col-xs-6 b-r"> <strong>Industry</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['industry']; ?></p>
                                        </div>
                                        <div class="col-md-2 col-xs-6 b-r"> <strong>Address</strong>
                                            <br>
                                        ...
                                        <div class="col-md-2 col-xs-6 b-r"> <strong>Contact No.</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['contact']; ?></p>
                                        </div>
                                        <div class="col-md-2 col-xs-6"> <strong>Website</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['website']; ?></p>
                                        </div>
                                    </div>
                                    <hr>
