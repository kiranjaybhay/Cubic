...
// , requirements='$requirements'
    $sql = "UPDATE job SET title='$title',location='$location',position='$position', description='$description',experience='$experience', salary='$salary',worktype='$status' WHERE id=$id";
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form method="post" action="form_layout2.php">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="title" name="title" class="form-control"  value="<?php echo $row['title']; ?> "placeholder="Enter candidate name">  </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label">position:</label>
                                                        <input type="text" id="position"name="position" class="form-control" value="<?php echo $row['position']; ?> " placeholder="position">  </div>
                                                </div>
                                                 <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label">Location:</label>
                                                        <input type="text" id="location"name="location" class="form-control" value="<?php echo $row['location']; ?> " placeholder="location">  </div>
                                                </div>
                                                <!--/span-->
                                            </div>
                                            <!--/row-->
                                            ...
                                            <div class="row">
                                                 <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder=""  value="<?php echo $row['salary'];?>" name="salary"> </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <!--/row-->
                                                <div class="col-md-4">
                                                     <div class="form-group ">
                                                        ...
                                                        <input type="text" id="experience"name="experience" class="form-control" value="<?php echo $row['experience'];?>" placeholder="contact">  </div>
                                                </div>
                                         ...
                                         <div class="col-md-4">
                                                   ...
                                                   <textarea name="description" value="<?php echo $row['description'];?>" class="form-control" rows="2" ></textarea>
                                                    </div>
                                                </div>
                                                </div>
                                                </div>
