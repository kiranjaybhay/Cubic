            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="side-menu">
                                ...
                                <!-- <li><a href="data_table3.php">Table 3</a><i class="icon-grid fa-fw"></i></li>
                                <li><a href="data_table4.php">Table 4</a><i class="icon-grid fa-fw"></i></li>
                                <li><a href="data_table5.php">Table 5</a><i class="icon-grid fa-fw"></i></li> -->
                        ...
                        <!-- <li> 
                            <a class="waves-effect" href="data-table.php" aria-expanded="false"><i class="icon-grid fa-fw"></i> <span class="hide-menu"> Tables</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="data_table.php">Table 1</a></li>
                            </ul>
                              <ul aria-expanded="false" class="collapse">
                                <li><a href="data_table2.php">Table 2</a></li>
                            </ul>  <ul aria-expanded="false" class="collapse">
                                <li><a href="data_table3.php">Table 3</a></li>
                            </ul>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="data_table4.php">Table 4</a></li>
                            </ul><ul aria-expanded="false" class="collapse">
                                <li><a href="data_table5.php">Table 5</a></li>
                            </ul>
                        </li> -->
                        <!-- <li>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <a class="btn btn-primary" href="add.php" role="button">Add Data</a></p>
...
In this example, for each delete button, a JavaScript event listener is attached that shows a confirmation alert before proceeding with the delete action. If the user clicks "Cancel" in the alert, the delete action is prevented.

Please note that this is a simple example and doesn't handle the actual deletion of items from the database. In a real application, you would need to send a request to the server (using AJAX or form submission) to delete the item from the database and then update the UI accordingly.
