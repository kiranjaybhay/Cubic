     ...
     <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <ul class="nav nav-tabs tabs customtab">
                                ...
                                <li class="active tab">
                                    <a href="#profile" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">View Scheduled interviews Details</span> </a>
                                </li>
                                <!-- <li class="tab">
                    ...
                    $result = $conn->query($sql);
                                ...
                                <div class="tab-pane active" id="profile">
                                    <div class="row">
                                        <div class="col-md-2 col-xs-6 b-r"> <strong>Candidate Id </strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['candidate_id']; ?></p>
                                        </div>
                                        ...
                                        <div class="col-md-2 col-xs-6 b-r"> <strong>Date</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['interview_date']; ?></p>
                                        </div>
                                        <div class="col-md-2 col-xs-6 b-r"> <strong> Interview time</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['interview_time']; ?></p>
                                        </div>
                                        <!-- <div class="col-md-2 col-xs-6"> <strong>contact</strong>
                                            <br>
