...
if (isset($_POST['submit'])) {
    ...
    $gratuation = $_POST['gratuation'];
    $collegename = $_POST['collegename'];
    $collegemark = $_POST['collegemark'];
    $collegeyear = $_POST['collegeyear'];

    $sql = "UPDATE userdetails SET name='$name',mname='$mname',email='$email',dob='$dob', contact='$contact',status='$status',skill='$skills' WHERE cadidate_id=$cadidate_id";
    mysqli_query($conn, $sql);

    $sql2 = "UPDATE education SET course='$class',school='$school',grade='$mark', year='$year' WHERE id=$id1";
    mysqli_query($conn, $sql2);

    $sql3 = "UPDATE education SET course='$class12',school='$cname',grade='$classmark',year='$classyear' WHERE id=$id2";
    mysqli_query($conn, $sql3);

    $sql4 = "UPDATE education SET course='$gratuation',school='$collegename',grade='$collegemark', year='$collegeyear' WHERE id=$id3";
    mysqli_query($conn, $sql4);
    
    for ($i=0; $i < count($_POST['lastcompany']) ; $i++) { 
        $workexprience_id = $_POST['workexprience_id'][$i];
        $lastcompany = $_POST['lastcompany'][$i];
        $lastposition = $_POST['lastposition'][$i];
        $sdate = $_POST['sdate'][$i];
        $edate = $_POST['edate'][$i];
        $sql5 = "UPDATE workexprience SET companyname='$lastcompany',position='$lastposition',startdate='$sdate', enddate='$edate' WHERE id=$workexprience_id";
...
if (isset($_GET['cadidate_id'])) {
    $id = $_GET['cadidate_id'];
    $sql = "SELECT * FROM userdetails WHERE cadidate_id='$id'";
    // $sql2 = "SELECT * FROM education WHERE cadidate_id='$id'";
    $sql3 = "SELECT * FROM workexprience WHERE cadidate_id='$id'";
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    ...
                                    <form method="post" action="form_layout.php">
                                         <input type="hidden" name="cadidate_id" value="<?php echo $_GET['cadidate_id']; ?> ">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name" name="name" class="form-control"  value="<?php echo $row['name']; ?> " placeholder="Enter candidate name">  </div>
                                                </div>
                                         
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label">Mother Name</label>
                                                        <input type="text" id="mname"name="mname" class="form-control"  value="<?php echo $row['mname']; ?> " >  </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                   <div class="form-group ">
                                                        ...
                                                        <input type="email" id="email"name="email" class="form-control"  value="<?php echo $row['email']; ?> " placeholder="Email">  </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder=""  value="<?php echo $row['dob']; ?> " name="dob"> </div>
                                                </div>
                                     
                                                <div class="col-md-4">
                                                     <div class="form-group ">
                                                        <label class="control-label">contact</label>
                                                        <input type="text" id="contact"name="contact" class="form-control"   value="<?php echo $row['contact']; ?> " placeholder="contact">  </div>
                                                </div>
                                                 <div class="col-md-4">
                                                    <div class="form-group ">
...
if ($result->num_rows > 0) {
    while ($row2 = $result->fetch_assoc()) {
        if (trim($row2["course"]) == 10) {
            ?>
                <hr> 
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label"></label> </br>10th Class </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group ">
                            ...
                            <input type="text"  name="class" class="form-control"   value="<?php echo $row2["course"];?>"readonly>  </div>  
                        </div> 
                        <div class="col-md-3">
                        <div class="form-group ">
                            <label class="control-label">School/College </label>
                            <input type="text"  name="school" class="form-control"  value="<?php echo $row2["school"];?>">  </div> 
                        </div>                                                
                    <div class="col-md-2">
                        <div class="form-group ">
                            <label class="control-label">Marks </label>
                            <input type="text" name="mark" class="form-control"  value="<?php echo $row2["grade"];?>"> </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group ">
                        <label class="control-label">Passing year</label>
                        <input type="text"  name="year" class="form-control"  value="<?php echo $row2["year"];?>">  
                        </div>
                    </div>

                </div>
        <?php } 
        if ( trim($row2["course"]) == "12" || trim($row2["course"]) == "Diploma" ) { ?> 
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label"></label> </br>12th/Diploma 
                            </div>
                        </div>
                        <!--/span-->
                        <div class="col-md-2">
                            <div class="form-group ">
                                <label class="control-label">class </label>
                                <input type="text" id="school" name="class12" class="form-control"  value="<?php echo $row2["course"];?>" placeholder=""readonly>  
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group ">
                                <label class="control-label">College </label>
                                <input type="text" id="school" name="cname" class="form-control"  value="<?php echo $row2["school"];?>" placeholder="">  
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group ">
                                <label class="control-label">Marks </label>
                                <input type="text" id="mark" name="classmark" class="form-control"  value="<?php echo $row2["grade"];?>" placeholder="">  
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group ">
                                <label class="control-label">Passing year</label>
                                <input type="text" id="year" name="classyear" class="form-control"  value="<?php echo $row2["year"];?>" placeholder="">  
                            </div>
                        </div>
                    </div>
                        ...
                        if ( trim($row2["course"]) == "degree" ){ ?> 
                      
                
                    <input type="hidden" name="id3" value="<?php echo $row2['id'];  ?> ">


                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label"></label> </br>Graduation 
                            </div>
                        </div>
                        <!--/span-->
                        <div class="col-md-2">
                            <div class="form-group ">
                                <label class="control-label">class </label>
                                <input type="text" id="school" name="gratuation" class="form-control"  value="<?php echo $row2["course"];?>" placeholder=""readonly>  
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group ">
                                <label class="control-label">College </label>
                                <input type="text" id="school" name="collegename" class="form-control"  value="<?php echo $row2["school"]; ?>" placeholder="">  
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group ">
                                <label class="control-label">Marks </label>
                                <input type="text" id="mark"name="collegemark" class="form-control"  value="<?php echo $row2["grade"];?>" placeholder="">  
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group ">
                                <label class="control-label">Passing year</label>
                                <input type="text" id="year" name="collegeyear" class="form-control"  value="<?php echo $row2["year"];?>" placeholder="">  
                            </div>
                        </div>
                            </div>
...
<hr>
        ...
        // if ($row3["companyname"] == "appmonks") { 
            ?>

                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label class="control-label"></br>Company Details</label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="company" name="lastcompany[]" class="form-control"  value="<?php echo $row3['companyname']; ?>" placeholder="Enter company name">  </div>
                                                        <input type="hidden" name="workexprience_id[]" value="<?php echo $row3['id']; ?>">
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-3">
                                                    <div class="form-group ">
                                                        <label class="control-label">Position </label>
                                                        <input type="text" id="position"name="lastposition[]" class="form-control"  value="<?php echo $row3['position']; ?>" placeholder="position">  </div>
                                                </div>
                                                <!--/span-->
                                            <!-- </div> -->
                                            ...
                                            <!-- <div class="row"> -->
                                                 <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" placeholder=""  value="<?php echo $row3['startdate']; ?>" name="sdate[]"> </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <!--/row-->
                                                 ...
                                                 <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" placeholder=""  value="<?php echo $row3['enddate']; ?>" name="edate[]"> </div>
                                                </div>
                                                </div>
                            <?php }}?>
                                                ...
                                                <div class="row">
                                                 <div class="col-md-4">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" id="skills"name="skills" class="form-control"  value="<?php echo $row['skill']; ?> " placeholder="skills">  </div>
                                        </div>
                                        </div>
                                                 ...
                                                 <!-- <div class="col-md-4">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="file" id="resume"name="resume" accept=".pdf" class="form-control"  value="<?php echo $row['file']; ?> " placeholder="Email">  </div>
