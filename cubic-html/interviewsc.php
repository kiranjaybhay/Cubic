...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO interview (candidate_id,name,interview_date,interview_time) VALUES ('$id', '$name','$date','$interview_time')";

    // $sql = "UPDATE userdetails SET name='$name',email='$email',dob='$dob', contact='$contact',status='$status' WHERE stud_id=$id";
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading">Interview schedule </div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form method="post" action="interviewsc.php">
                                        <div class="form-body">
                                            <h3 class="box-title">Interview </h3>
                                            <hr>
                                            <div class="input-group">
                                                <!-- <div class="input-group-addon"><i class="ti-user"></i></div> -->
                                                <input type="hidden" name="id" value="<?php echo $row['cadidate_id']; ?> "></div>
                                        </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <!-- <input type="date" name="date" class="form-control" value="<?php echo $row['interview_date']; ?>" >  </div> -->
                                                        <input type="date" id="date" name="date" class="form-control">  </div>
                                            ...
                                            <div class="row">
                                                 <div class="col-md-6">
                                                     <div class="form-group ">
                                                        ...
                                                        <input type="time" id="interview_time"name="interview_time" class="form-control" >  </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group ">
                                                       ...
                                                       <select class="form-control" name="status">
                                                        <option value="Available">scheduled</option>
                                                          <option value="offered">cancel</option>
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-success" name="submit"> <i class="fa fa-check"></i>  schedule interview</button>
                                        <!-- <button type="submit" name="submit"class="btn btn-success waves-effect waves-light m-r-10">Add candidate</button> -->
