...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO service (name,service_type,price,valadity,description) VALUES ('$name','$service_type', '$price','$valadity','$description')";
                                ...
                                <div class="panel-body">
                                    <form method="post" action="addservice.php">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" id="price" name="price" class="form-control" placeholder="Service Price"required>  </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group ">
                                                        <label class="control-label">Service Valadity:</label>
                                                        <input type="text" id="valadity"name="valadity" class="form-control" placeholder="Valadity"required>  </div>
                                                </div>
                                                <!--/span-->
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-success" name="submit"> <i class="fa fa-check"></i> Add Service</button>
