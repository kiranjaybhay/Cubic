            ...
            <ul id="side-menu">
                ...
                <li>
                 ...
                 <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li> <a href="alljob.php">Add Job</a> </li>
                        <li> <a href="alljob.php">All Jobs</a> </li>
                    </ul>
                </li>
                 <li>
                    <a class="waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="icon-grid fa-fw"></i>  <span class="hide-menu">Company details</span></a>
                    <ul aria-expanded="false" class="collapse">
                ...
                <li>
                    <a class="active waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="icon-basket fa-fw"></i> <span class="hide-menu">Services</span></a>
                    <ul aria-expanded="false" class="collapse">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0);" class="text-link">Admin</a></td>
                        ...
                        <div class="white-box chat-widget">
                            ...
                            <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                                <li>
                                    ...
                                    <div class="chat-body">
                                        <div class="chat-text">
                                            <p><span class="font-semibold">Admin</span> Hey Daniel, This is just a sample chat. </p>
                                        </div>
                                        <span>2 Min ago</span>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="chat-body">
                                        <div class="chat-text">
                                            <p><span class="font-semibold">Admin</span> Bye now. </p>
                                        </div>
                                        <span>1 Min ago</span>
                                    </div>
                                </li>
