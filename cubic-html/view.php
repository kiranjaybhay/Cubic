...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO userdetails (date,categary,perticular,description) VALUES ('$date', '$categary','$perticular','$description')";
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <ul class="nav nav-tabs tabs customtab">
                                ...
                                <li class="active tab">
                                    <a href="#profile" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">View Candidate Details</span> </a>
                                </li>
                                ...
                                <div class="tab-pane active" id="profile">
                                    <div class="row">
                                        <div class="col-md-2 col-xs-6 b-r"> <strong>Sr.No. </strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['cadidate_id']; ?></p>
                                        </div>
                                        ...
                                        </div><div class="col-md-2 col-xs-6"> <strong>contact</strong>
                                            <br>
    ...
    while ($row2 = $result->fetch_assoc()) {
        if ($row2["course"] == 10) { ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-2 col-xs-6 b-r"> <strong>Sr.No. </strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row2['cadidate_id']; ?></p>
                                        </div> -->
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Educational Details</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row2['course']; ?></p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>School Name</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row2['school']; ?></p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Marks</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row2['grade']; ?></p>
                                        </div><div class="col-md-3 col-xs-6"> <strong>Year</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row2['year']; ?></p>
                                        </div>
                                    </div>
                                    <hr>
                                     <?php } elseif (
