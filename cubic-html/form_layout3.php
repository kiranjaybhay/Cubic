...
if (isset($_POST['submit'])) {
   ...
   $name = $_POST["name"];
    ...
    $sql = "UPDATE company SET name='$name',industry='$industry',email='$email',address='$address',contact='$contact', website='$website', discription='$discription' WHERE id=$id";
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form method="post" action="form_layout3.php">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" id="industry"name="industry" class="form-control" value="<?php echo $row['industry']; ?> " placeholder="Email">  </div>
                                                </div>
                                                 <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label">Email</label>
                                                        <input type="text" id="discription"name="email" value="<?php echo $row['email']; ?> " class="form-control" placeholder="Email">  </div>
                                                </div>
                                           ...
                                           <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder=""  value="<?php echo $row['contact'];?>" name="contact"> 
                                                    </div>
                                                </div>
                                          <div class="col-md-4">
                                                     <div class="form-group ">
                                                        <label class="control-label">Website</label>
                                                        <input type="text" id="website"name="website" class="form-control" value="<?php echo $row['website'];?>" placeholder="contact"> 
                                                     </div>
                                                </div>
                                                </div>
                                                 <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <!-- <input type="text" id="discription"name="discription" value="<?php echo $row['discription'];?>" class="form-control" placeholder="discription"> -->
                                                          <textarea name="discription" value="" class="form-control" rows="2" ><?php echo $row['discription'];?></textarea>  
                                                    </div>
                                                </div>
                                                </div>
                                        </div>
