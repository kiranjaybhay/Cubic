...
<body class="mini-sidebar">
    ...
    <div id="wrapper">
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0"> All Candidate</h3>
        ...
        $sql = "SELECT * FROM userdetails ORDER BY cadidate_id DESC";
        $result = mysqli_query($conn, $sql);
        if (mysqli_num_rows($result) > 0) {
            $sr = 1;
            while ($row = mysqli_fetch_assoc($result)) {
                echo '<tr>';
                echo '<td>' . $row['cadidate_id'] . '</td>';
                echo '<td>' . $row['name'] . '</td>';
                ...
                // Uncomment the lines below if you want to include other columns
                // echo '<td>' . $row['position'] . '</td>';
                // echo '<td>' . $row['experience'] . '</td>';
                // echo '<td>' . $row['education'] . '</td>';
                echo '<td>' . $row['status'] . '</td>';
                echo '<td>';
                echo '<button type="button" class="btn btn-info" style= "margin: 2px";><a href="view.php?cadidate_id=' . $row['cadidate_id'] . '"> View </a></button>';
                echo '<button type="button" class="btn btn-info" style= "margin: 2px";><a href="form_layout.php?cadidate_id=' . $row['cadidate_id'] . '"> Edit </a></button>';
                echo '<button type="button" class="btn btn-info" style= "margin: 2px";><a href="delete.php?cadidate_id=' . $row['cadidate_id'] . '" class="delete-button"> Delete </a></button>';
                echo '</td>';
                echo '</tr>';
            }
        }
