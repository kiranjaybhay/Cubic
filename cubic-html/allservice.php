    ...
    <div id="wrapper">
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0"> All Service</h3>
                            <p class="text-muted m-b-30">  </p>
                            <p align="right">

                            <a class="btn btn-primary" href="addservice.php" role="button">Add Service</a></p>
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>' . $row['valadity'] . '</td>';
                echo '<td>' . $row['description'] . '</td>';
                echo '<td>';
                echo '<button type="button" class="btn btn-info" style= "margin: 2px";><a href="view4.php?id=' . $row['id'] . '"> View </a></button>';
                echo '<button type="button" class="btn btn-info" style= "margin: 2px";><a href="form_layout4.php?id=' . $row['id'] . '"> Edit </a></button>';
                echo '<button type="button" class="btn btn-info" style= "margin: 2px";><a href="delete4.php?id=' . $row['id'] . '" class="delete-button"> Delete </a></button>';
                echo '</td>';
                echo '</tr>';
            }
        }
