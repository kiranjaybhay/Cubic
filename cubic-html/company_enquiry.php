...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM company_enquiry WHERE id='$id'";
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <ul class="nav nav-tabs tabs customtab">
                                ...
                                <li class="active tab">
                                    <a href="#profile" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">View Company Enquiry</span> </a>
                                </li>
                                <!-- <li class="tab">
                                ...
                                <div class="tab-pane active" id="profile">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-xs-6 b-r"> <strong>Full Name</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['Company_name']; ?></p>
                                        </div>
                                        <div class="col-md-4 col-xs-6 b-r"> <strong>Email</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['email']; ?></p>
                                        </div>
                                        <div class="col-md-4 col-xs-6 b-r"> <strong>Message</strong>
                                            <br>
