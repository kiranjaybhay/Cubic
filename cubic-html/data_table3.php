                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <a class="btn btn-primary" href="add3.php" role="button">Add Data</a></p>
        ...
        ?>
                                    <tbody>
                                        <tr>
                                              ...
                                              <td>  
                                               <a href="view3.php?id=<?php echo $row['id']; ?>">View</a>
                                               <a href="form_layout3.php?id=<?php echo $row['id']; ?>">Edit</a>
                                               <!-- <a href="delete.php?id=<?php echo $row['id']; ?>">Delete</a> -->
                                               <a href="delete3.php?id=<?php echo $row['id']; ?>" class="delete-button">Delete</a>
