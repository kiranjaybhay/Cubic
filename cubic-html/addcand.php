...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO userdetails (name,mname,position,email,dob,contact,address,gender,status,marital_status,file,skill) VALUES ('$name','$mname','$position''$email','$dob','$contact','$address','$radio','$status','$marriedstatus','$resume','$skill')";
   
    if (mysqli_query($conn, $sql)) {
         $last_id = $conn->insert_id;
      
        
         $sql2 = "INSERT INTO education (cadidate_id,course,school,grade,year) VALUES ('$last_id','$class', '$school','$mark','$year'),
          ('$last_id','$class12', '$cname','$classmark','$classyear'),('$last_id','$gratuation', '$collegename','$collegemark','$collegeyear');";
        if (mysqli_multi_query($conn, $sql2)) {
            // header("Location: viewcand.php");
            }else{
                 echo "Error: " . $sql2 . "<br>" . mysqli_error($conn);
            }
                     $sql3 = "INSERT INTO workexprience (cadidate_id,companyname,position,startdate,enddate,skill) VALUES 
                     ('$last_id','$lastcompany', '$lastposition','$sdate','$edate','$skill')
                     ,('$last_id','$company', '$position','$sddate','$eddate','$skill');";
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name" name="name" class="form-control" placeholder="Enter candidate name" required>  </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-3">
                                                    <div class="form-group ">
                                                        <label class="control-label">Mother Name</label>
                                                        <input type="text" id="mname"name="mname" class="form-control" placeholder="Mother Name"required>  </div>
                                                </div>
                                                 <div class="col-md-3">
                                                    <div class="form-group ">
                                                        <label class="control-label">Position</label>
                                                        <input type="text" id="mname"name="position" class="form-control" placeholder="position"required>  </div>
                                                </div>
                                                <!--/span-->
                                            </div>
                                             <div class="row">
                                                ...
                                                <!--/span-->
                                                 ...
                                                 <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="dob"required> </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                            ...
                                            <!--/row-->
                                             <div class="row">
                                                <div class="col-md-3">
                                                 ...
                                                 <div class="col-md-3">
                                                    <div class="form-group ">
                                                       <label for="status">Candidate Status:</label><br>
                                                 ...
                                                 <div class="col-md-3">
                                                    <div class="form-group ">
                                                       <label for="marriedstatus">Marital Status:</label><br>
                                         ...
                                         <h3 class="box-title">Education Details </h3>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label class="control-label"></label> </br> Details </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        ...
                                                        <!-- <input type="text" id="school" name="class" class="form-control" placeholder="10th"readonly>  -->
                                                     </div>   </div> 
                                                    <div class="col-md-3">
                                                    <div class="form-group ">
                                                        <label class="control-label">School/College </label>
                                                        <input type="text" id="school" name="school" class="form-control" placeholder=""required>  </div> </div>                                                
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        <label class="control-label">Marks </label>
                                                        <input type="text" id="mark"name="mark" class="form-control" placeholder=""required>  </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        <label class="control-label">Passing year</label>
                                                        <input type="text" id="year" name="year" class="form-control" placeholder=""required>  </div>
                                                    </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label class="control-label"></label> </br></div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        <label class="control-label">class </label>
                                                        <select class="form-control" name="class12"required>
                                                            <option value="12">12th</option>
                                                            <option value="Diploma">Diploma</option>
                                                         </select>
                                                        <!-- <input type="text" id="school" name="class12" class="form-control" placeholder=""required>   -->
                                                    </div>  
                                                    </div>
                                                     <div class="col-md-3">
                                                    <div class="form-group ">
                                                        <label class="control-label">College </label>
                                                        <input type="text" id="school" name="cname" class="form-control" placeholder=""required>  </div>  
                                                    </div>
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        <label class="control-label">Marks </label>
                                                        <input type="text" id="mark"name="classmark" class="form-control" placeholder=""required>  </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        <label class="control-label">Passing year</label>
                                                        <input type="text" id="year" name="classyear" class="form-control" placeholder=""required>  </div>
                                                    </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        <label class="control-label">class </label>
                                                         <select class="form-control" name="gratuation"required>
                                                    ...
                                                    <div class="form-group ">
                                                        <label class="control-label">College </label>
                                                        <input type="text" id="school" name="collegename" class="form-control" placeholder=""required>  </div>                                               
                                                     </div>
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        <label class="control-label">Marks </label>
                                                        <input type="text" id="mark"name="collegemark" class="form-control" placeholder=""required>  </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group ">
                                                        <label class="control-label">Passing year</label>
                                                        <input type="text" id="year" name="collegeyear" class="form-control" placeholder=""required>  </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Last Company name</label>
                                                        <input type="text" id="company" name="lastcompany" class="form-control" placeholder="Enter company name"required>  </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-3">
                                                    <div class="form-group ">
                                                        <label class="control-label">Position </label>
                                                        <input type="text" id="position"name="lastposition" class="form-control" placeholder="position"required>  </div>
                                                </div>
                                                <!--/span-->
                                            <!-- </div> -->
                                            ...
                                            <!-- <div class="row"> -->
                                                 <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="sdate"required> </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <!--/row-->
                                                 ...
                                                 <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="edate"required> </div>
                                                </div>
                                                </div>
                                                <div class="row">
                                                <div class="col-md-2">
                                            ...
                                            <!-- <div class="row"> -->
                                                 <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label class="control-label"> Start Date</label>
                                                        <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="sddate"> </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <!--/row-->
                                                 ...
                                                 <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label class="control-label">End Date </label>
                                                        <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="eddate"> </div>
                                                </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                 <div class="col-md-2">
                                                    <div class="form-group ">
                                                        <!-- <label class="control-label"></br>Skills</label> -->
                                        ...
                                        <div class="col-md-4">
                                                 ...
                                                 <div class="col-md-4">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="file" id="resume"name="resume" accept=".pdf" class="form-control" placeholder="Email"required>  </div>
