...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE table5 SET date='$date',categary='$categary',perticular='$perticular', description='$description' WHERE id=$id";
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Update Data</h3>
                            <p class="text-muted m-b-30 font-13">   </p>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="form_layout5.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="date" value="<?php echo $row['date']; ?>"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputpwd1">Categary</label>
                                            <div class="input-group">
                                                <!-- <div class="input-group-addon"><i class="ti-lock"></i></div> -->
                                                <input type="text" name="categary" value="<?php echo $row['categary']; ?>"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputpwd2">Perticular </label>
                                            <div class="input-group">
                                                <!-- <div class="input-group-addon"><i class="ti-lock"></i></div> -->
                                                <input type="text" name="perticular" value="<?php echo $row['perticular']; ?>"></div>
