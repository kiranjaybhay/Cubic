                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <ul class="nav nav-tabs tabs customtab">
                                ...
                                <li class="active tab">
                                    <a href="#profile" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">View Job details</span> </a>
                                </li>
                                <!-- <li class="tab">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="profile">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 col-xs-6 b-r"> <strong>Location:</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['location']; ?></p>
                                        </div>
                                        <div class="col-md-2 col-xs-6 b-r"> <strong>Job Description:</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['description']; ?></p>
                                        </div>
                                        <div class="col-md-2 col-xs-6 b-r"> <strong>Position:</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['position']; ?></p>
                                        </div>
                                         <div class="col-md-2 col-xs-6 b-r"> <strong>Experience:</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $row['experience']; ?></p>
                                        </div>
                                        <div class="col-md-2 col-xs-6 b-r"> <strong>Salary:</strong>
                                            <br>
