<aside class="sidebar">
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="side-menu">
                <li>
                    <a class="active waves-effect" href="javascript:void(0);" aria-expanded="false">
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li> <a href="../candidate_profile/add.php">Add Candidate </a> </li>
                        <li> <a href="candidate_profile/view.php">All Candidate</a> </li>
                    </ul>
                </li>
